# Pyrebase was made and cloned from https://github.com/thisbejim/Pyrebase
# All work with the exception of set_access_token and set_creds are the work 
# of James Childs-Maidment
