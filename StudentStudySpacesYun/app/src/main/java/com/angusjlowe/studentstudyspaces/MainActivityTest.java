...
public class MainActivityTest extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.testing_view_activity_main);
    ...
    public void serverCheck(View v) {
        AlertDialog.Builder builder = new AlertDialog.Builder(MainActivityTest.this).setTitle("Firebase JSON").setMessage(alertDialogMessage);
